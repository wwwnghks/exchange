								...
								<table id="mList" width="700" border="3" bordercolor="lightgray">
									...
									<c:forEach var="message" items="${sMessageList}">
										<tr align="center">
											...
											<td><a href="sMessageRead?msg_idx=${message.msg_idx }&mem_nickname=${message.mem_nickname}">${message.msg_title}</a></td>
											...
											<td><fmt:formatDate value="${message.msg_regdate}" pattern="yyyy.MM.dd"/></td>
