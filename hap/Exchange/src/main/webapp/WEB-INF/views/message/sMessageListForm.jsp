...
<body>
			...
			<div class="container background-white">
				<div class="row margin-vert-40">
					...
					<%-- <div id="wrap">
						...
						<div id="topForm">
							<form name="form1" method="post" action="sMessageList">
						...
						<div id="message">
							...
							<table id="mList" style="width: 700px" class="table ">
								...
								<c:forEach varStatus="status" var="message" items="${map.list}">
									<tr>
										<td>${(map.count-status.index)-((map.paging.curPage-1)*10)}<input type="hidden" name="msg_idx"
							...
							<button type="submit" class="btn btn-primary">목.록</button>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		...
		function listnum(page) {
			location.href = "/exchange/message/sMessageList?curPage=" + page
