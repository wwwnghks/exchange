                    ...
                    <div class="row padding-top-40">
                        <ul class="portfolio-group">
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeInLeft">
                                        <img alt="image1" src="<%=request.getContextPath() %>/resources/HTML/assets/img/frontpage/image1.jpg">
                                        <figcaption>
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeIn">
                                        <img alt="image2" src="<%=request.getContextPath() %>/resources/HTML/assets/img/frontpage/image2.jpg">
                                        <figcaption>
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeInRight">
                                        <img alt="image3" src="<%=request.getContextPath() %>/resources/HTML/assets/img/frontpage/image3.jpg">
                                        <figcaption>
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeInLeft">
                                        <img alt="image4" src="<%=request.getContextPath() %>/resources/HTML/assets/img/frontpage/image4.jpg">
                                        <figcaption>
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeIn">
                                        ...
                                        <img alt="image5" src="<%=request.getContextPath() %>/resources/HTML/assets/img/frontpage/image5.jpg">
                                        <figcaption>
                            ...
                            <li class="portfolio-item col-sm-4 col-xs-6 margin-bottom-40">
                                <a href="#">
                                    <figure class="animate fadeInRight">
                                        <img alt="image6" src="<%=request.getContextPath() %>/resources/HTML/assets/img/frontpage/image6.jpg">
                                        <figcaption>
