   ...
   <div class="container bottom-border padding-vert-30">
      <div class="row">
         ...
         <div class="col-md-4 margin-bottom-20">
            ...
            <p>
               <span class="fa-phone">Telephone:</span>1-800-123-4567 <br> <span
   ...
   <div class="container">
      <div class="row">
         ...
         <div id="footermenu" class="col-md-8">
            ...
            <p>상호: (주) exchange 사업장소재지: 서울특별시 서초구 강남대로53길 8 비트아카데미빌딩</p>
            <p>사업자 등록번호: 02-3486-9600  통신판매업신고: 제2016-서울강남-01184호 
            <a href="#" class="btn btn-sm btn-grey" 
            style="font-size:10px !important;line-height:15px !important;">사업자정보 확인</a></p>
            <p >대표이사: 임수빈 &nbsp; 개인정보책임자: 김영의</p>
         </div>
         <!-- End Footer Menu -->
         <!-- Copyright -->
         <div id="copyright" class="col-md-4">
            <p class="pull-right">(c) 2018 exchange</p>
         </div>
         <!-- End Copyright -->
      </div>
   </div>
