...
public class Member {
	...
	public Member(int mem_idx, String mem_id, String mem_pw, String mem_pwc, String mem_name, Date mem_birth,
			String mem_nickname, String mem_phone, String mem_email, String address_post, String address_01,
			String address_02, String mem_address, String mem_photo, String mem_birth1, String mem_birth2,
			String mem_birth3, MultipartFile photofile, float mem_score, int mem_scorecnt) {
		super();
		this.mem_idx = mem_idx;
		this.mem_id = mem_id;
		this.mem_pw = mem_pw;
		this.mem_pwc = mem_pwc;
	...
	public String toString() {
		return "Member [mem_idx=" + mem_idx + ", mem_id=" + mem_id + ", mem_pw=" + mem_pw + ", mem_pwc=" + mem_pwc
				+ ", mem_name=" + mem_name + ", mem_birth=" + mem_birth + ", mem_nickname=" + mem_nickname
				+ ", mem_phone=" + mem_phone + ", mem_email=" + mem_email + ", address_post=" + address_post
				+ ", address_01=" + address_01 + ", address_02=" + address_02 + ", mem_address=" + mem_address
				+ ", mem_photo=" + mem_photo + ", mem_birth1=" + mem_birth1 + ", mem_birth2=" + mem_birth2
				+ ", mem_birth3=" + mem_birth3 + ", photofile=" + photofile + ", mem_score=" + mem_score
				+ ", mem_scorecnt=" + mem_scorecnt + "]";
	}

	public String getMem_pwc() {
		return mem_pwc;
	}

	public void setMem_pwc(String mem_pwc) {
		this.mem_pwc = mem_pwc;
	}
